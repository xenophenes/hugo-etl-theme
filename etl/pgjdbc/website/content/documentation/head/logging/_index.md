...
[Java Logging Overview](https://docs.oracle.com/javase/8/docs/technotes/guides/logging/overview).
...
the enabling of the Logger using [connection properties](logging#conprop), which uses a static
