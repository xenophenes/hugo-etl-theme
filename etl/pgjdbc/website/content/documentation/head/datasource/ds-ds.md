...
PostgreSQL™ includes two implementations of `DataSource`, as shown in [Table 11.2, “`DataSource` Implementations”](ds-ds#ds-ds-imp).
...
`DataSource` be configured via JavaBean properties, shown in [Table 11.3, “`DataSource` Configuration Properties”](ds-ds#ds-ds-props),
...
which are shown in [Table 11.4, “Additional Pooling `DataSource` Configuration Properties](ds-ds#ds-ds-xprops).
...
[Example 11.1, “`DataSource` Code Example”](ds-ds#ds-example) shows an example
