...
* **sslfactory** = String
	...
	called [“Custom SSLSocketFactory”](ssl-factory).

* **sslfactoryarg** (deprecated) = String

	This value is an optional argument to the constructor of the sslfactory
	class provided above. For more information see the section called [“Custom SSLSocketFactory”](ssl-factory).
...
* **sslmode** = String
	...
	["Configuring the client"](ssl-client) for details.
...
* **prepareThreshold** = int
	...
	[“Server Prepared Statements”](server-prepare).
